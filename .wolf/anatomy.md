...
- `README.md` — Project documentation (~499 tok)
...
- `ai-guardian.json` (~266 tok)

## .claude/

- `settings.json` (~441 tok)
- `settings.local.json` (~412 tok)

## .claude/rules/

- `openwolf.md` (~313 tok)

## .claude/skills/ai-guardian-security/

- `SKILL.md` — AI Guardian Security Advisor (~2007 tok)

## .claude/skills/ai-guardian-security/references/

- `TOOLS.md` — AI Guardian MCP Tools Reference (~824 tok)

## .claude/skills/release/

- `EXAMPLE_USAGE.md` — Release Skill Usage Examples (~1536 tok)
- `README.md` — Project documentation (~1187 tok)
- `release_helper.py` — VersionFile: read_version, write_version, in, get_current_version + 3 more (~9599 tok)
- `SKILL.md` — Release Skill (~5872 tok)
...
- `bug-reports.yml` (~558 tok)
- `ideas.yml` (~278 tok)
- `q-a.yml` (~211 tok)

## .github/ISSUE_TEMPLATE/

- `bug-report.yml` (~1094 tok)
- `feature-request.yml` (~601 tok)
- `pattern-enhancement.md` — 📚 Source Information (~1124 tok)
...
- `storage-user-5c03ae68-38e0-41c7-bdf0-94b18705cecd.json` (~592 tok)
- `storage-user-8f384c1e-3bca-44b8-ba99-e3e24d79df5f.json` (~12 tok)
- `storage-user-bd0ff7a1-340c-4906-8222-bb8c5eb7eaa5.json` (~39 tok)

## .opencode/

- `.gitignore` — Git ignore rules (~17 tok)
- `package-lock.json` — npm lock file (~3959 tok)
...
- `11248075880631222914` — Declares E2ELegitimateWorkflowTests (~54742 tok)
- `11604706606251763659` (~38 tok)
- `11714227202416335740` (~38 tok)
- `11856764698458822025` — Declares if (~150240 tok)
- `12688293526207289742` (~3792 tok)
- `13557702066230530462` (~30728 tok)
- `13968935710496993282` — Declares ToolPolicyExpirationTest (~7296 tok)
- `16178935697851355535` (~38 tok)
- `17334434352421252098` (~38 tok)
- `17394069628479438492` (~38 tok)
- `4463510042893737397` — Declares E2ELegitimateWorkflowTests (~54742 tok)
- `8170611304334835321` (~38 tok)
- `939103690342658946` (~28 tok)
- `9488019011187197847` — Declares activeLink (~227585 tok)
- `9575943495385580489` (~3606 tok)

## .ruff_cache/0.15.19/

- `10879831979707328581` (~3422 tok)
- `14123887908810801365` (~3394 tok)
- `4703194999183377022` (~37 tok)

## .ruff_cache/0.15.21/

- `3914736999613163825` (~142 tok)
- `6586334241352152861` (~46 tok)

## .ruff_cache/0.15.22/

- `15840820299713694256` (~99 tok)

## .ruff_cache/0.16.0/

- `15809778354744770921` (~61 tok)
- `4676347274172383435` (~4748 tok)
- `4755777076549555969` (~65 tok)
- `5431046533033251896` (~4615 tok)

## .ruff_cache/0.16.1/

- `15809778354744770921` (~101 tok)
- `387245393175880902` (~46 tok)
...
- `activate` — Permission is hereby granted, free of charge, to any person obtaining (~1094 tok)
- `activate_this.py` — Permission is hereby granted, free of charge, to any person obtaining (~694 tok)
- `activate.bat` (~712 tok)
- `activate.csh` — Permission is hereby granted, free of charge, to any person obtaining (~702 tok)
- `activate.fish` — Permission is hereby granted, free of charge, to any person obtaining (~1121 tok)
- `activate.nu` — Permission is hereby granted, free of charge, to any person obtaining (~1007 tok)
- `activate.ps1` — Permission is hereby granted, free of charge, to any person obtaining (~743 tok)
- `ai-guardian` — -*- coding: utf-8 -*- (~87 tok)
- `bandit` — -*- coding: utf-8 -*- (~85 tok)
- `bandit-baseline` — -*- coding: utf-8 -*- (~86 tok)
- `bandit-config-generator` — -*- coding: utf-8 -*- (~88 tok)
- `deactivate.bat` (~462 tok)
- `docutils` — -*- coding: utf-8 -*- (~86 tok)
- `dotenv` — -*- coding: utf-8 -*- (~85 tok)
- `f2py` — -*- coding: utf-8 -*- (~86 tok)
- `fastapi` — -*- coding: utf-8 -*- (~84 tok)
- `hf` — -*- coding: utf-8 -*- (~87 tok)
- `httpx` — -*- coding: utf-8 -*- (~83 tok)
- `httpx2` — -*- coding: utf-8 -*- (~84 tok)
- `huggingface-cli` — -*- coding: utf-8 -*- (~90 tok)
- `idna` — -*- coding: utf-8 -*- (~83 tok)
- `jp.py` — main (~491 tok)
- `jsonschema` — -*- coding: utf-8 -*- (~85 tok)
- `markdown-it` — -*- coding: utf-8 -*- (~87 tok)
- `markdown2` — -*- coding: utf-8 -*- (~84 tok)
- `mcp` — -*- coding: utf-8 -*- (~83 tok)
- `nicegui-pack` — -*- coding: utf-8 -*- (~87 tok)
- `normalizer` — -*- coding: utf-8 -*- (~90 tok)
- `numpy-config` — -*- coding: utf-8 -*- (~86 tok)
- `onnxruntime_test` — -*- coding: utf-8 -*- (~90 tok)
- `py.test` — -*- coding: utf-8 -*- (~87 tok)
- `pydoc.bat` (~325 tok)
- `pygmentize` — -*- coding: utf-8 -*- (~86 tok)
- `pytest` — -*- coding: utf-8 -*- (~87 tok)
- `rapidocr_onnxruntime` — -*- coding: utf-8 -*- (~88 tok)
- `rst2html` — -*- coding: utf-8 -*- (~87 tok)
- `rst2html4` — -*- coding: utf-8 -*- (~87 tok)
- `rst2html5` — -*- coding: utf-8 -*- (~87 tok)
- `rst2latex` — -*- coding: utf-8 -*- (~87 tok)
- `rst2man` — -*- coding: utf-8 -*- (~86 tok)
- `rst2odt` — -*- coding: utf-8 -*- (~86 tok)
- `rst2pseudoxml` — -*- coding: utf-8 -*- (~90 tok)
- `rst2s5` — -*- coding: utf-8 -*- (~86 tok)
- `rst2xetex` — -*- coding: utf-8 -*- (~87 tok)
- `rst2xml` — -*- coding: utf-8 -*- (~86 tok)
- `tiny-agents` — -*- coding: utf-8 -*- (~90 tok)
- `tqdm` — -*- coding: utf-8 -*- (~83 tok)
- `typer` — -*- coding: utf-8 -*- (~84 tok)
- `uvicorn` — -*- coding: utf-8 -*- (~84 tok)
- `watchfiles` — -*- coding: utf-8 -*- (~84 tok)
- `websockets` — -*- coding: utf-8 -*- (~85 tok)

## .venv/lib/python3.12/site-packages/

- `_editable_impl_ai_guardian.pth` (~7 tok)
- `_virtualenv.pth` (~5 tok)
- `_virtualenv.py` — Patches that are applied at runtime to the virtual environment. (~1241 tok)
- `markdown2.py` — URL configuration (~54460 tok)
...
## .venv/lib/python3.12/site-packages/ai_guardian-1.16.0.dev0.dist-info/

- `direct_url.json` (~19 tok)
...
## .venv/lib/python3.12/site-packages/ai_guardian-1.16.0.dev0.dist-info/licenses/

- `LICENSE` — Project license (~196 tok)
- `NOTICE` (~55 tok)

## .venv/lib/python3.12/site-packages/ai_guardian/

- `pyproject.toml` — Python project configuration (~1569 tok)
- `README.md` — Project documentation (~8041 tok)

## .venv/lib/python3.12/site-packages/aiofiles-25.1.0.dist-info/
...
## .venv/lib/python3.12/site-packages/aiofiles-25.1.0.dist-info/licenses/
...
## .venv/lib/python3.12/site-packages/aiohttp-3.13.5.dist-info/
...
## .venv/lib/python3.12/site-packages/aiohttp-3.13.5.dist-info/licenses/

- `LICENSE.txt` (~147 tok)

## .venv/lib/python3.12/site-packages/aiohttp-3.13.5.dist-info/licenses/vendor/llhttp/
...
## .venv/lib/python3.12/site-packages/bandit/
...
## .venv/lib/python3.12/site-packages/bandit/blacklists/
...
## .venv/lib/python3.12/site-packages/bandit/cli/
...
## .venv/lib/python3.12/site-packages/bandit/core/
...
## .venv/lib/python3.12/site-packages/bandit/formatters/
...
- `secret_redaction.py` — Secret Redaction page — redaction configuration and statistics. (~5501 tok)
- `ssrf.py` — SSRF Protection page — network request filtering and IP blocking. (~9026 tok)
- `traces.py` — Trace Viewer page — conversation traces from GuardedAgent runs. (~11212 tok)
- `tray_plugins.py` — Tray Plugins page — manage tray menu plugin JSON files. (~3999 tok)
- `violation_detail.py` — Violation detail page — dedicated view with deep-link support. (~3375 tok)
- `violations.py` — Violations page — tabbed browser with details/correlation matching TUI. (~12480 tok)

## src/ai_guardian/web/services/

- `daemon_service.py` — DaemonService: refresh_targets, targets, get_target_by_name, get_all_daemon_status + 30 more (~3495 tok)

## tests/

- `conftest.py` — isolated_config_dir, test_something, isolated_config_with_file, test_something (~1502 tok)

## tests/unit/

- `test_ai_guardian.py` — AIGuardianTest: test_check_secrets_with_clean_content, test_check_secrets_with_list_content, test_ch (~25490 tok)
- `test_ask_forwarding.py` — Tests for remote ask dialog forwarding (#1342). (~4405 tok)
- `test_bundled_toml.py` — Tests for bundled TOML pattern files. (~5737 tok)
- `test_code_annotator.py` — Tests for code_annotator module — batch annotation insertion logic. (~2652 tok)
...
- `test_daemon_client.py` — Tests for daemon client. (~6962 tok)
- `test_daemon_discovery.py` — Tests for multi-daemon discovery engine. (~21376 tok)
- `test_daemon_rest_api.py` — Tests for daemon REST API. (~10214 tok)
- `test_daemon_server.py` — Tests for daemon server. (~12692 tok)
- `test_daemon_traces.py` — Tests for the trace viewer module (daemon/traces.py). (~8059 tok)
- `test_daemon_tray.py` — Tests for daemon system tray integration. (~75625 tok)
- `test_directory_blocking_violation_reason.py` — Tests for directory_blocking violation reason differentiation (issue #347). (~2130 tok)
- `test_doctor.py` — TestCheckStatus: test_values, test_defaults, test_exit_code_all_pass, test_exit_code_with_warnings + (~22288 tok)
- `test_file_scanner.py` — TestFileScannerSecretScanning: test_secrets_detected, test_no_secrets, test_secrets_disabled, test_s (~9744 tok)
- `test_git_workflow.py` — Tests for git_workflow module — git operations for --annotate. (~1915 tok)
- `test_hook_adapters.py` — Tests for the multi-agent hook adapter architecture (Issue #633). (~23976 tok)
- `test_hook_helpers.py` — Tests for extracted hook_processing helper functions. (~2614 tok)
- `test_hook_processing.py` — HookInputParsingTests: test_valid_json_processed, test_userpromptsubmit_hook_processing, test_pretoo (~8696 tok)
- `test_ide_session_auto_refresh.py` — Tests for auto-refresh on IDE Session list and detail pages (#2024, #2119). (~2459 tok)
- `test_ide_session_violations.py` — Tests for violation links in IDE Session viewer (#2022). (~1063 tok)
...
- `test_project_init.py` — Tests for ai-guardian init-project command. (~12966 tok)
- `test_prompt_injection_line_numbers.py` — Tests for prompt injection line number reporting (Issue #953). (~2839 tok)
- `test_prompt_injection.py` — PromptInjectionDetectorTest: test_clean_prompt_passes, test_ignore_instructions_pattern, test_develo (~23380 tok)
- `test_sandbox_command.py` — Tests for the ``ai-guardian sandbox`` lifecycle command. (~17010 tok)
- `test_sanitizer.py` — TestGetSanitizeConfig: test_config_has_all_pii_types, test_config_has_empty_allowlists, test_config_ (~10471 tok)
- `test_scan_analyzer.py` — " in result.recommended_ignore_paths["secret_scanning"] (~4023 tok)
- `test_scan_diff_integration.py` — Integration tests for scan_command() with diff flags. (~3280 tok)
- `test_scan_pipeline.py` — Tests for the shared content scanning pipeline (scanners.pipeline). (~7436 tok)
- `test_scan_result.py` — Tests for universal ScanResult dataclass (Issue #1251). (~3923 tok)
- `test_scanner_installer.py` — TestScannerConfigLoading: test_load_config_finds_pyproject, test_load_config_has_repos, test_load_co (~14828 tok)
- `test_scanner_line_numbers.py` — Tests for line number and snippet extraction in scanner findings. (~2974 tok)
- `test_sdk_config_overlay.py` — TestResolveSDKOverlay: test_no_overlay_returns_none, test_file_overlay_via_env_var, test_inline_over (~13320 tok)
- `test_sdk.py` — Tests for the AI Guardian SDK module. (~14038 tok)
- `test_secret_scanning_ignore.py` — TestSecretScanningIgnoreTools: test_ignore_tools_exact_match, test_ignore_tools_wildcard_pattern, te (~6666 tok)
- `test_setup.py` — TestIDESetup: test_detect_ide_none, test_detect_ide_single, test_detect_ide_multiple, test_list_dete (~54601 tok)
- `test_shell_hooks.py` — Tests for config-driven shell hooks around GuardedAgent callbacks (#2087). (~4281 tok)
- `test_source_command.py` — Tests for source_command field in tool_result violations (Issue #1903). (~1497 tok)
- `test_ssrf_protection.py` — TestSSRFProtectorCore: test_disabled_protection, test_non_bash_tool_allowed, test_empty_command, tes (~16088 tok)
- `test_target_config.py` — Tests for target project config loading and allowlist merging. (~3723 tok)
...
- `test_tray_plugins.py` — Tests for tray menu plugin loader and command utilities. (~39142 tok)
- `test_tui.py` — TestTUIApp: test_tui_initialization, test_tui_has_screens, test_nav_groups_has_ten_categories, test_ (~16290 tok)
- `test_update_checker.py` — Tests for the update_checker module (Issue #2155). (~4569 tok)
- `test_violation_context_enrichment.py` — TestExtractContextSnippet: test_basic_snippet_extraction, test_first_line_detection, test_last_line_ (~6616 tok)
- `test_violation_file_path_line_number.py` — Tests that all violation log entries include file_path and line_number fields (Issue #349). (~7477 tok)
- `test_violation_logging_types.py` — Tests for ssrf_blocked and config_file_exfil violation logging types. (~3673 tok)
...
- `test_user_experience_contract_no_bypass_hints.py` — TestSecretDetectedMessageNoBypassHints: test_secret_message_with_details, test_secret_message_withou (~1695 tok)
- `test_user_experience_contract_pii.py` — PIIUserPromptSubmitTests: test_user_prompt_with_ssn_blocked, test_user_prompt_without_pii_allowed, t (~6210 tok)
- `test_user_experience_contract_posttooluse_secret.py` — PostToolUseSecretBlockingTests: test_posttooluse_blocks_secret_when_redaction_disabled, test_posttoo (~9700 tok)
